...
const audienceStats = [
    ...
    { value: "8,400+", label: "Monthly Readers (est.)", icon: "👁️" },
    { value: "4,280+", label: "Resource Downloads", icon: "⬇️" },
    ...
    const assets = {
        presspack: {
            ...
            content: [
                ...
                "",
                "AUDIENCE",
                "- 1,247+ newsletter subscribers",
                "- 8,400+ monthly readers (estimated)",
                "- 4,280+ resource downloads",
        ...
        audiencereport: {
            ...
            content: [
                ...
                "",
                "AUDIENCE METRICS",
                "Newsletter subscribers:    1,247+",
                "Monthly readers (est.):    8,400+",
                "Resource downloads:        4,280+",
